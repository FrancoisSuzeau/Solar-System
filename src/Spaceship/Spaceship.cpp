...
{
    if((m_spaceship_models != nullptr) && ((render_data.getShader("model") != nullptr)))
    {
        ...
        m_spaceship_models->draw(render_data, m_model_matrice);
    }
}
...
/******************************************************************************* loadModelShip *************************************************************************/
/***********************************************************************************************************************************************************************/
void Spaceship::loadModelShip(RenderData &render_data)
{
