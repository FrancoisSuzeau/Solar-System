...
/******************************************************************************** draw *********************************************************************************/
/***********************************************************************************************************************************************************************/
void Model::draw(std::vector<glm::mat4> projection_view_model_mat, glm::vec3 camPos, bool hdr, Shader *model_shader)
{
    ...
    if(model_shader != nullptr)
    {
        ...
        {
            m_meshes[i].draw(projection_view_model_mat, camPos, hdr, model_shader);
        }
