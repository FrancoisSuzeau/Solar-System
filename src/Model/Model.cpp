...
/******************************************************************************** draw *********************************************************************************/
/***********************************************************************************************************************************************************************/
void Model::draw(RenderData &render_data, glm::mat4 &model_mat, glm::vec3 camPos, Shader *model_shader)
{
    ...
    if(model_shader != nullptr)
    {
        ...
        {
            m_meshes[i].draw(render_data, model_mat, camPos, model_shader);
        }
