...
OpenGlSketch::OpenGlSketch(/*std::string window_title,*/ SDL_Window *window, int width, int height): /*m_window_title(window_title),*/ m_window_width(width), m_window_height(height), m_window(window)
//, m_input()
//m_openGL_context(0), m_window(0), m_initiGLEW(0), m_input()
{
...
//     /******************************************************************* RENDER FLARE ***********************************************************************/
//             solar_system->renderFlareSun(render_data);
//     //======================================================================================================================================================
