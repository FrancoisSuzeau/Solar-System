...
void PlanetarySystem::initData()
{
    ...
    m_data.push_back({"../assets/textures/CelestialBody/SaturnCloud.jpg", "../assets/textures/normalMap/saturn_normalMap.jpg", "../assets/textures/displacementMap/saturn_dispMap.jpg", "Saturn", 283.476f, 26.73f, glm::vec3(0.0, -142670, 0)});
}
